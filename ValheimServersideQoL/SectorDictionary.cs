...
sealed class SectorDictionary<TKey, TValue>(float sectorWidth) : IDictionary<(Vector3, TKey), TValue>, IReadOnlyDictionary<(Vector3, TKey), TValue>
        where TKey : notnull
{
    float _scale = sectorWidth > 0 ? 1f / sectorWidth : throw new ArgumentOutOfRangeException(nameof(sectorWidth));
...
static class SectorDictionary
{
    ...
    public static bool TryAdd(this SectorDictionary<HashSet<ExtendedZDO>> @this, Vector3 key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
    {
    ...
    public static bool TryAdd(this SectorDictionary<HashSet<ExtendedZDO>> @this, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
    ...
    public static void Add<TCollection>(this SectorDictionary<TCollection> @this, Vector3 key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TCollection : class, ICollection<ExtendedZDO>, new()
    {
    ...
    public static void Add<TCollection>(this SectorDictionary<TCollection> @this, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TCollection : class, ICollection<ExtendedZDO>, new()
        => @this.Add(zdo.GetPosition(), zdo, autoRemoveOnDestroyed);

    public static bool TryAdd<TCollection>(this SectorDictionary<TCollection> @this, Vector3 key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TCollection : class, ICollection<ExtendedZDO>, new()
    {
        var collection = @this.GetOrAdd(key);
    ...
    public static bool TryAdd<TCollection>(this SectorDictionary<TCollection> @this, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TCollection : class, ICollection<ExtendedZDO>, new()
        => @this.TryAdd(zdo.GetPosition(), zdo, autoRemoveOnDestroyed);
    ...
    public static bool TryAdd<TKey>(this SectorDictionary<TKey, HashSet<ExtendedZDO>> @this, (Vector3, TKey) key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TKey : notnull
    {
        var set = @this.GetOrAdd(key);
        if (!set.Add(zdo))
    ...
    public static bool TryAdd<TKey>(this SectorDictionary<TKey, HashSet<ExtendedZDO>> @this, TKey key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TKey : notnull
    ...
    public static void Add<TKey, TCollection>(this SectorDictionary<TKey, TCollection> @this, (Vector3, TKey) key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TKey : notnull
        where TCollection : class, ICollection<ExtendedZDO>, new()
    {
        var collection = @this.GetOrAdd(key);
    ...
    public static void Add<TKey, TCollection>(this SectorDictionary<TKey, TCollection> @this, TKey key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TKey : notnull
        where TCollection : class, ICollection<ExtendedZDO>, new()
        => @this.Add((zdo.GetPosition(), key), zdo, autoRemoveOnDestroyed);

    public static bool TryAdd<TKey, TCollection>(this SectorDictionary<TKey, TCollection> @this, (Vector3, TKey) key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TKey : notnull
        where TCollection : class, ICollection<ExtendedZDO>, new()
    {
        var collection = @this.GetOrAdd(key);
    ...
    public static bool TryAdd<TKey, TCollection>(this SectorDictionary<TKey, TCollection> @this, TKey key, ExtendedZDO zdo, bool autoRemoveOnDestroyed = true)
        where TKey : notnull
        where TCollection : class, ICollection<ExtendedZDO>, new()
        => @this.TryAdd((zdo.GetPosition(), key), zdo, autoRemoveOnDestroyed);
    ...
    public static bool Remove<TKey, TCollection>(this SectorDictionary<TKey, TCollection> @this, TKey key, ExtendedZDO zdo)
        where TKey : notnull
        where TCollection : class, ICollection<ExtendedZDO>
