...
### Component: ZSyncTransform (Greydwarf)
...
### Component: ZSyncAnimation (Greydwarf)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Greydwarf)
...
### Component: CharacterDrop (Greydwarf)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: FootStep (Greydwarf)
