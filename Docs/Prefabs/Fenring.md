...
### Component: ZSyncTransform (Fenring)
...
### Component: ZSyncAnimation (Fenring)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Fenring)
...
### Component: CharacterDrop (Fenring)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: FootStep (Fenring)
