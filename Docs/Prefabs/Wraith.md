...
### Component: ZSyncTransform (Wraith)
...
### Component: ZSyncAnimation (Wraith)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Wraith)
...
### Component: CharacterDrop (Wraith)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: CharacterAnimEvent (wraith)
