...
### Component: DropOnDestroyed (ashland_pot3_red)
...
### Component: HoverText (ashland_pot3_red)

|Field|Type|Default Value|
|-----|----|-------------|
|m_text|System.String|$piece_ancient_pot|

### Component: StaticPhysics (ashland_pot3_red)
...
### Component: WearNTear (ashland_pot3_red)
