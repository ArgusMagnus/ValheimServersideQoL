...
### Component: Humanoid (DvergerAshlands)
...
### Component: ZSyncTransform (DvergerAshlands)
...
### Component: ZSyncAnimation (DvergerAshlands)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (DvergerAshlands)
...
### Component: CharacterDrop (DvergerAshlands)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (DvergerAshlands)
...
### Component: FootStep (DvergerAshlands)
...
### Component: NpcTalk (DvergerAshlands)
