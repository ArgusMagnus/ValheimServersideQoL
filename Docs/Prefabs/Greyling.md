...
### Component: ZSyncTransform (Greyling)
...
### Component: ZSyncAnimation (Greyling)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Greyling)
...
### Component: CharacterDrop (Greyling)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: FootStep (Greyling)
