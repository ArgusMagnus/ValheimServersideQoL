...
### Component: Humanoid (Charred_Mage)
...
### Component: ZSyncTransform (Charred_Mage)
...
### Component: ZSyncAnimation (Charred_Mage)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Charred_Mage)
...
### Component: CharacterDrop (Charred_Mage)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Charred_Mage)
...
### Component: FootStep (Charred_Mage)
