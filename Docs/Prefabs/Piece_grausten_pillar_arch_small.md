...
### Component: Piece (Piece_grausten_pillar_arch_small)
...
### Component: WearNTear (Piece_grausten_pillar_arch_small)
...
### Component: RandomMaterialValues (Piece_grausten_pillar_arch_small)
