...
### Component: ZSyncTransform (GoblinKing)
...
### Component: ZSyncAnimation (GoblinKing)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (GoblinKing)
...
### Component: CharacterDrop (GoblinKing)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 3.00)|

### Component: FootStep (GoblinKing)
...
### Component: LightLod (Point light (2))
