...
### Component: ZSyncTransform (DvergerArbalest_shootAshlands)
...
### Component: ItemDrop (DvergerArbalest_shootAshlands)
...
### Component: Floating (DvergerArbalest_shootAshlands)
