...
### Component: TimedDestruction (sfx_hatchling_coldball_explode)
...
### Component: ZSFX (sfx_hatchling_coldball_explode)
...
### Component: CamShaker (sfx_hatchling_coldball_explode)
