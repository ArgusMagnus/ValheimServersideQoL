...
### Component: Piece (cauldron_ext5_mortarandpestle)
...
### Component: WearNTear (cauldron_ext5_mortarandpestle)
...
### Component: StationExtension (cauldron_ext5_mortarandpestle)
