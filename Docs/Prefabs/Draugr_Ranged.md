...
### Component: Humanoid (Draugr_Ranged)
...
### Component: ZSyncTransform (Draugr_Ranged)
...
### Component: ZSyncAnimation (Draugr_Ranged)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Draugr_Ranged)
...
### Component: CharacterDrop (Draugr_Ranged)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Draugr_Ranged)
...
### Component: FootStep (Draugr_Ranged)
...
### Component: CharacterAnimEvent (_draugr_base)
