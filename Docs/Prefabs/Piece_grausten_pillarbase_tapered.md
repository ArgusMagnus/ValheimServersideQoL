...
### Component: Piece (Piece_grausten_pillarbase_tapered)
...
### Component: WearNTear (Piece_grausten_pillarbase_tapered)
...
### Component: RandomMaterialValues (Piece_grausten_pillarbase_tapered)
