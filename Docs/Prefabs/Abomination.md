...
### Component: Humanoid (Abomination)
...
### Component: ZSyncTransform (Abomination)
...
### Component: ZSyncAnimation (Abomination)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Abomination)
...
### Component: CharacterDrop (Abomination)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Abomination)
...
### Component: FootStep (Abomination)
