...
### Component: Humanoid (TrainingDummy)
...
### Component: ZSyncTransform (TrainingDummy)
...
### Component: ZSyncAnimation (TrainingDummy)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (TrainingDummy)
...
### Component: CharacterDrop (TrainingDummy)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (TrainingDummy)
...
### Component: FootStep (TrainingDummy)
