...
### Component: ZSyncTransform (Skeleton)
...
### Component: ZSyncAnimation (Skeleton)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Skeleton)
...
### Component: CharacterDrop (Skeleton)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Skeleton)
