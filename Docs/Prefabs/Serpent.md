...
### Component: ZSyncTransform (Serpent)
...
### Component: ZSyncAnimation (Serpent)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Serpent)
...
### Component: CharacterDrop (Serpent)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: Tail (Serpent)
