...
### Component: ZSyncTransform (charred_fireball_aoe)
...
### Component: Aoe (charred_fireball_aoe)
...
### Component: TimedDestruction (sfx_charred_mage_attack_impact)
...
### Component: ZSFX (sfx_charred_mage_attack_impact)
