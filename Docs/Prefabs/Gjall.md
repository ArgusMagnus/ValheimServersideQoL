...
### Component: ZSyncTransform (Gjall)
...
### Component: ZSyncAnimation (Gjall)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Gjall)
...
### Component: WeakSpot (WEAKSPOT_EGGS)
