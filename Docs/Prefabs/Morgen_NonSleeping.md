...
### Component: Humanoid (Morgen_NonSleeping)
...
### Component: ZSyncTransform (Morgen_NonSleeping)
...
### Component: ZSyncAnimation (Morgen_NonSleeping)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Morgen_NonSleeping)
...
### Component: CharacterDrop (Morgen_NonSleeping)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: FootStep (Morgen_NonSleeping)
