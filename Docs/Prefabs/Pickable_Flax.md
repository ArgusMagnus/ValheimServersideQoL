...
### Component: Destructible (Pickable_Flax)
...
### Component: StaticTarget (Pickable_Flax)
...
### Component: StaticPhysics (Pickable_Flax)
...
### Component: Pickable (Pickable_Flax)
...
### Component: DropOnDestroyed (Pickable_Flax)
