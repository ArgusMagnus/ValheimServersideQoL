...
### Component: Piece (Piece_grausten_pillarbase_small)
...
### Component: WearNTear (Piece_grausten_pillarbase_small)
...
### Component: RandomMaterialValues (Piece_grausten_pillarbase_small)
