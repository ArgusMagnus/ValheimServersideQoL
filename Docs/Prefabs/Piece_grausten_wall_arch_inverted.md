...
### Component: Piece (Piece_grausten_wall_arch_inverted)
...
### Component: WearNTear (Piece_grausten_wall_arch_inverted)
...
### Component: RandomMaterialValues (Piece_grausten_wall_arch_inverted)
