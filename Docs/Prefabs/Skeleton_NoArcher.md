...
### Component: Humanoid (Skeleton_NoArcher)
...
### Component: ZSyncTransform (Skeleton_NoArcher)
...
### Component: ZSyncAnimation (Skeleton_NoArcher)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Skeleton_NoArcher)
...
### Component: CharacterDrop (Skeleton_NoArcher)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Skeleton_NoArcher)
...
### Component: FootStep (Skeleton_NoArcher)
