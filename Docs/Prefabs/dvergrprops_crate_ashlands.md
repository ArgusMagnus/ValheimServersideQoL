...
### Component: DropOnDestroyed (dvergrprops_crate_ashlands)
...
### Component: WearNTear (dvergrprops_crate_ashlands)
...
### Component: HoverText (dvergrprops_crate_ashlands)

|Field|Type|Default Value|
|---|---|---|
|m_text|System.String|$piece_crate|

### Component: StaticPhysics (dvergrprops_crate_ashlands)
