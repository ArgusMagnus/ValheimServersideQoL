...
### Component: Pickable (Pickable_SeedOnion)
...
### Component: Destructible (Pickable_SeedOnion)
...
### Component: StaticTarget (Pickable_SeedOnion)
...
### Component: StaticPhysics (Pickable_SeedOnion)
