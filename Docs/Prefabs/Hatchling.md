...
### Component: ZSyncTransform (Hatchling)
...
### Component: ZSyncAnimation (Hatchling)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Hatchling)
...
### Component: CharacterDrop (Hatchling)
