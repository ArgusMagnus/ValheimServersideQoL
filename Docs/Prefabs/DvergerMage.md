...
### Component: Humanoid (DvergerMage)
...
### Component: ZSyncTransform (DvergerMage)
...
### Component: ZSyncAnimation (DvergerMage)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (DvergerMage)
...
### Component: CharacterDrop (DvergerMage)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (DvergerMage)
...
### Component: FootStep (DvergerMage)
