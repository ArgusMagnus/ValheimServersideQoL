...
### Component: Humanoid (Charred_Melee_Dyrnwyn)
...
### Component: ZSyncTransform (Charred_Melee_Dyrnwyn)
...
### Component: ZSyncAnimation (Charred_Melee_Dyrnwyn)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Charred_Melee_Dyrnwyn)
...
### Component: CharacterDrop (Charred_Melee_Dyrnwyn)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Charred_Melee_Dyrnwyn)
...
### Component: FootStep (Charred_Melee_Dyrnwyn)
