...
### Component: Humanoid (Charred_Archer_Fader)
...
### Component: ZSyncTransform (Charred_Archer_Fader)
...
### Component: ZSyncAnimation (Charred_Archer_Fader)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Charred_Archer_Fader)
...
### Component: CharacterDrop (Charred_Archer_Fader)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Charred_Archer_Fader)
...
### Component: FootStep (Charred_Archer_Fader)
