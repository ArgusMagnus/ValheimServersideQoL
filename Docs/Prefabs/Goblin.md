...
### Component: ZSyncTransform (Goblin)
...
### Component: ZSyncAnimation (Goblin)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Goblin)
...
### Component: CharacterDrop (Goblin)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: RandomAnimation (Goblin)

|Field|Type|Default Value|
|-----|----|-------------|

### Component: VisEquipment (Goblin)
