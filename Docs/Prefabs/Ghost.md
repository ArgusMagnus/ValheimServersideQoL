...
### Component: ZSyncTransform (Ghost)
...
### Component: ZSyncAnimation (Ghost)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Ghost)
...
### Component: CharacterDrop (Ghost)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Ghost)
