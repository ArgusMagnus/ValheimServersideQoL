...
### Component: Container (TreasureChest_mountaincave_hildir)
...
### Component: Piece (TreasureChest_mountaincave_hildir)
...
### Component: WearNTear (TreasureChest_mountaincave_hildir)
