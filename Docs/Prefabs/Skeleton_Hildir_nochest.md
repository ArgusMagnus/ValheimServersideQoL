...
### Component: Humanoid (Skeleton_Hildir_nochest)
...
### Component: ZSyncTransform (Skeleton_Hildir_nochest)
...
### Component: ZSyncAnimation (Skeleton_Hildir_nochest)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Skeleton_Hildir_nochest)
...
### Component: CharacterDrop (Skeleton_Hildir_nochest)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Skeleton_Hildir_nochest)
...
### Component: FootStep (Skeleton_Hildir_nochest)
