...
### Component: ZSyncTransform (Bonemass)
...
### Component: ZSyncAnimation (Bonemass)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Bonemass)
...
### Component: CharacterDrop (Bonemass)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Bonemass)
