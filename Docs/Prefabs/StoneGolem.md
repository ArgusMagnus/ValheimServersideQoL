...
### Component: ZSyncTransform (StoneGolem)
...
### Component: ZSyncAnimation (StoneGolem)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (StoneGolem)
...
### Component: CharacterDrop (StoneGolem)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (StoneGolem)
