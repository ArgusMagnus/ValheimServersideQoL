...
### Component: ZSyncTransform (caverock_ice_stalagtite_falling)
...
### Component: ImpactEffect (caverock_ice_stalagtite_falling)
...
### Component: Floating (caverock_ice_stalagtite_falling)
...
### Component: TreeLog (caverock_ice_stalagtite_falling)
...
### Component: MaterialVariationWorld (caverock_ice_stalagtite_falling)
