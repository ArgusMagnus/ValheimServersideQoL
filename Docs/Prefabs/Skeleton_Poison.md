...
### Component: Humanoid (Skeleton_Poison)
...
### Component: ZSyncTransform (Skeleton_Poison)
...
### Component: ZSyncAnimation (Skeleton_Poison)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Skeleton_Poison)
...
### Component: CharacterDrop (Skeleton_Poison)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Skeleton_Poison)
...
### Component: FootStep (Skeleton_Poison)
