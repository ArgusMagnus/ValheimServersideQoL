...
### Component: DropOnDestroyed (ashland_pot2_red)
...
### Component: HoverText (ashland_pot2_red)

|Field|Type|Default Value|
|-----|----|-------------|
|m_text|System.String|$piece_ancient_pot|

### Component: StaticPhysics (ashland_pot2_red)
...
### Component: WearNTear (ashland_pot2_red)
