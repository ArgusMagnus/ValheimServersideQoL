...
### Component: ZSyncTransform (Volture)
...
### Component: ZSyncAnimation (Volture)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Volture)
...
### Component: CharacterDrop (Volture)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: CharacterAnimEvent (Volture)
...
### Component: AnimationEffect (Volture)
