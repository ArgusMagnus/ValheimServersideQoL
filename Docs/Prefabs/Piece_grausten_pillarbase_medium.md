...
### Component: Piece (Piece_grausten_pillarbase_medium)
...
### Component: WearNTear (Piece_grausten_pillarbase_medium)
...
### Component: RandomMaterialValues (Piece_grausten_pillarbase_medium)
