...
### Component: Humanoid (GoblinShaman_Hildir_nochest)
...
### Component: ZSyncTransform (GoblinShaman_Hildir_nochest)
...
### Component: ZSyncAnimation (GoblinShaman_Hildir_nochest)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (GoblinShaman_Hildir_nochest)
...
### Component: CharacterDrop (GoblinShaman_Hildir_nochest)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: RandomAnimation (GoblinShaman_Hildir_nochest)

|Field|Type|Default Value|
|---|---|---|

### Component: VisEquipment (GoblinShaman_Hildir_nochest)
...
### Component: FootStep (GoblinShaman_Hildir_nochest)
