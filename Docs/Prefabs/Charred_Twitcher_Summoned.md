...
### Component: Humanoid (Charred_Twitcher_Summoned)
...
### Component: ZSyncTransform (Charred_Twitcher_Summoned)
...
### Component: ZSyncAnimation (Charred_Twitcher_Summoned)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Charred_Twitcher_Summoned)
...
### Component: CharacterDrop (Charred_Twitcher_Summoned)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Charred_Twitcher_Summoned)
...
### Component: FootStep (Charred_Twitcher_Summoned)
