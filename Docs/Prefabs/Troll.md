...
### Component: ZSyncTransform (Troll)
...
### Component: ZSyncAnimation (Troll)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Troll)
...
### Component: CharacterDrop (Troll)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Troll)
