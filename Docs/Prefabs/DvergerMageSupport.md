...
### Component: Humanoid (DvergerMageSupport)
...
### Component: ZSyncTransform (DvergerMageSupport)
...
### Component: ZSyncAnimation (DvergerMageSupport)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (DvergerMageSupport)
...
### Component: CharacterDrop (DvergerMageSupport)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (DvergerMageSupport)
...
### Component: FootStep (DvergerMageSupport)
...
### Component: NpcTalk (DvergerMageSupport)
