...
### Component: Humanoid (GoblinShaman)
...
### Component: ZSyncTransform (GoblinShaman)
...
### Component: ZSyncAnimation (GoblinShaman)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (GoblinShaman)
...
### Component: CharacterDrop (GoblinShaman)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: RandomAnimation (GoblinShaman)

|Field|Type|Default Value|
|---|---|---|

### Component: VisEquipment (GoblinShaman)
...
### Component: FootStep (GoblinShaman)
