...
### Component: ZSyncTransform (vfx_Burning)
...
### Component: TimedDestruction (sfx_ui_player_firedamage_ignite)
...
### Component: ZSFX (sfx_ui_player_firedamage_ignite)
...
### Component: ZSFX (sfx_ui_player_firedamage_loop)
