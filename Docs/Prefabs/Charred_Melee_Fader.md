...
### Component: Humanoid (Charred_Melee_Fader)
...
### Component: ZSyncTransform (Charred_Melee_Fader)
...
### Component: ZSyncAnimation (Charred_Melee_Fader)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Charred_Melee_Fader)
...
### Component: CharacterDrop (Charred_Melee_Fader)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Charred_Melee_Fader)
...
### Component: FootStep (Charred_Melee_Fader)
