...
### Component: Humanoid (GoblinBrute_Hildir)
...
### Component: ZSyncTransform (GoblinBrute_Hildir)
...
### Component: ZSyncAnimation (GoblinBrute_Hildir)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (GoblinBrute_Hildir)
...
### Component: CharacterDrop (GoblinBrute_Hildir)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (GoblinBrute_Hildir)
...
### Component: FootStep (GoblinBrute_Hildir)
