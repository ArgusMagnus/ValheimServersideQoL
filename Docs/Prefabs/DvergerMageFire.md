...
### Component: Humanoid (DvergerMageFire)
...
### Component: ZSyncTransform (DvergerMageFire)
...
### Component: ZSyncAnimation (DvergerMageFire)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (DvergerMageFire)
...
### Component: CharacterDrop (DvergerMageFire)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (DvergerMageFire)
...
### Component: FootStep (DvergerMageFire)
...
### Component: NpcTalk (DvergerMageFire)
