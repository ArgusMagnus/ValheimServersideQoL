...
### Component: Humanoid (DvergerTest)
...
### Component: ZSyncTransform (DvergerTest)
...
### Component: ZSyncAnimation (DvergerTest)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (DvergerTest)
...
### Component: CharacterDrop (DvergerTest)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: RandomAnimation (DvergerTest)

|Field|Type|Default Value|
|---|---|---|

### Component: VisEquipment (DvergerTest)
...
### Component: FootStep (DvergerTest)
