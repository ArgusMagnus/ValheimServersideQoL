...
### Component: CharacterDrop (BlobTar)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: ZSyncTransform (BlobTar)
...
### Component: ZSyncAnimation (BlobTar)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (BlobTar)
