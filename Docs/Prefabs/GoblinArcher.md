...
### Component: Humanoid (GoblinArcher)
...
### Component: ZSyncTransform (GoblinArcher)
...
### Component: ZSyncAnimation (GoblinArcher)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (GoblinArcher)
...
### Component: CharacterDrop (GoblinArcher)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: RandomAnimation (GoblinArcher)

|Field|Type|Default Value|
|---|---|---|

### Component: VisEquipment (GoblinArcher)
...
### Component: FootStep (GoblinArcher)
