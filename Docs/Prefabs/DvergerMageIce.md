...
### Component: Humanoid (DvergerMageIce)
...
### Component: ZSyncTransform (DvergerMageIce)
...
### Component: ZSyncAnimation (DvergerMageIce)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (DvergerMageIce)
...
### Component: CharacterDrop (DvergerMageIce)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (DvergerMageIce)
...
### Component: FootStep (DvergerMageIce)
...
### Component: NpcTalk (DvergerMageIce)
