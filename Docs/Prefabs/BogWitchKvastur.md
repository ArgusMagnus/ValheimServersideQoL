...
### Component: Humanoid (BogWitchKvastur)
...
### Component: ZSyncTransform (BogWitchKvastur)
...
### Component: ZSyncAnimation (BogWitchKvastur)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (BogWitchKvastur)
...
### Component: CharacterDrop (BogWitchKvastur)
