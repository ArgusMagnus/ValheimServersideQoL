...
### Component: ZSyncTransform (Draugr)
...
### Component: ZSyncAnimation (Draugr)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Draugr)
...
### Component: CharacterDrop (Draugr)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: VisEquipment (Draugr)
