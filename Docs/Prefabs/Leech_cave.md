...
### Component: ZSyncTransform (Leech_cave)
...
### Component: ZSyncAnimation (Leech_cave)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Leech_cave)
...
### Component: CharacterDrop (Leech_cave)
