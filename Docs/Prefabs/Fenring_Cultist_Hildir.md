...
### Component: Humanoid (Fenring_Cultist_Hildir)
...
### Component: ZSyncTransform (Fenring_Cultist_Hildir)
...
### Component: ZSyncAnimation (Fenring_Cultist_Hildir)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Fenring_Cultist_Hildir)
...
### Component: CharacterDrop (Fenring_Cultist_Hildir)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: FootStep (Fenring_Cultist_Hildir)
