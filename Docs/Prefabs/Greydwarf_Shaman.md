...
### Component: Humanoid (Greydwarf_Shaman)
...
### Component: ZSyncTransform (Greydwarf_Shaman)
...
### Component: ZSyncAnimation (Greydwarf_Shaman)

|Field|Type|Default Value|
|-----|----|-------------|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Greydwarf_Shaman)
...
### Component: CharacterDrop (Greydwarf_Shaman)

|Field|Type|Default Value|
|-----|----|-------------|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: FootStep (Greydwarf_Shaman)
