...
### Component: Projectile (projectile_meteor)
...
### Component: ZSyncTransform (projectile_meteor)
...
### Component: CinderSpawner (projectile_meteor)

|Field|Type|Default Value|
|---|---|---|
|m_cinderPrefab|UnityEngine.GameObject|Cinder|
|m_cinderInterval|System.Single|0.1|
