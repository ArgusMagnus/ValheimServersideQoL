...
### Component: CharacterDrop (Ulv)

|Field|Type|Default Value|
|---|---|---|
|m_spawnOffset|UnityEngine.Vector3|(0.00, 0.00, 0.00)|

### Component: ZSyncTransform (Ulv)
...
### Component: ZSyncAnimation (Ulv)

|Field|Type|Default Value|
|---|---|---|
|m_smoothCharacterSpeeds|System.Boolean|True|

### Component: MonsterAI (Ulv)
...
### Component: CharacterAnimEvent (Ulv)
