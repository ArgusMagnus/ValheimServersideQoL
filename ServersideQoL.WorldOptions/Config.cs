...
public sealed class Config(ConfigFile cfg, Logger logger) : ConfigBase<Config>(cfg, logger)
{
  ...
  public ConfigEntry<RemoveMistlandsMistOptions> RemoveMistlandsMist { get; } = BindEx(cfg, RemoveMistlandsMistOptions.AfterQueenKilled, """
  ...
  public ConfigEntry<float> MapTableMapViewDistance { get; } = BindEx(cfg, 0f, $"""
  ...
  public ConfigEntry<bool> CraftingStationsShareBuildRadius { get; } = BindEx(cfg, false, """
